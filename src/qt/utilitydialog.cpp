    ...
    ui(new Ui::AboutDialog)
{
    ...
    ui->copyrightLabel->setText(tr("Copyright") + QString(" &copy; %1 ").arg(COPYRIGHT_YEAR) + tr("The GameCredits Foundation"));
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("GameCredits Core") + " " + tr("version") + " " +
...
void ShutdownWindow::showShutdownWindow(BitmarkGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("GameCredits Core is shutting down...") + "<br /><br />" +
